function [flag] = FigureS5D_20190624_runSingleParams_pons()
flag = 1;
%% Run function for Figure S5D
...
paramset5 = [.1; .23*20; param10000(3,i(1))*21;param10000(4:end,i(1))];
paramset7 = [.1./10; (.23*20)./10; param10000(3,i(1))*21;param10000(4:end,i(1))];

% get all parameters
paramset = [paramset5, paramset7];
