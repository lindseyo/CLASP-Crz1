...
figure(911); imagesc(kdVSslowGRID'); yticklabels({'1 x','1/5 x','1/10 x','1/20 x'}); xticklabels({'0.5','2.3','10','20','46'}); title(['Protein', 'g1 = ',num2str(g1), '-- kd vs speed']);
colorbar; xlabel('kd'); caxis([1.1 2.1]);

%% g1 = 0.1
load('20191001_model_valsGen_GRIDg1pt1.mat')
g1 = 0.1; 
% PLOTTING GRID -- code for plotting slope ratio for PROTEIN
ratioSlope = [];
for i = 1:20
...
figure(912); imagesc(kdVSslowGRID'); yticklabels({'1 x','1/5 x','1/10 x','1/20 x'}); xticklabels({'0.5','2.3','10','20','46'}); title(['Protein', 'g1 = ',num2str(g1), '-- kd vs speed']);
colorbar; xlabel('kd'); caxis([1.1 2.1]);
%% g1 = 0.5
load('20191001_model_valsGen_GRIDg1pt5.mat')
g1 = 0.5; 
% PLOTTING GRID -- code for plotting slope ratio for PROTEIN
ratioSlope = [];
for i = 1:20
...
figure(913); imagesc(kdVSslowGRID'); yticklabels({'1 x','1/5 x','1/10 x','1/20 x'}); xticklabels({'0.5','2.3','10','20','46'}); title(['Protein', 'g1 = ',num2str(g1), '-- kd vs speed']);
colorbar; xlabel('kd'); caxis([1.1 2.1]);
%% g1 = 1
load('20191001_model_valsGen_GRIDg1.mat')
g1 = 1; 
% PLOTTING GRID -- code for plotting slope ratio for PROTEIN
ratioSlope = [];
for i = 1:20
...
figure(914); imagesc(kdVSslowGRID'); yticklabels({'1 x','1/5 x','1/10 x','1/20 x'}); xticklabels({'0.5','2.3','10','20','46'}); title(['Protein', 'g1 = ',num2str(g1), '-- kd vs speed']);
colorbar; xlabel('kd'); caxis([1.1 2.1]);
%% g1 = 5
load('20191001_model_valsGen_GRID5.mat')
g1 = 5; 
% PLOTTING GRID -- code for plotting slope ratio for PROTEIN
ratioSlope = [];
for i = 1:20
...
figure(915); imagesc(kdVSslowGRID'); yticklabels({'1 x','1/5 x','1/10 x','1/20 x'}); xticklabels({'0.5','2.3','10','20','46'}); title(['Protein', 'g1 = ',num2str(g1), '-- kd vs speed']);
colorbar; xlabel('kd'); caxis([1.1 2.1]);
%% g1 = 10
load('20191001_model_valsGen_GRID10.mat')
g1 = 10; 
% PLOTTING GRID -- code for plotting slope ratio for PROTEIN
ratioSlope = [];
for i = 1:20
...
figure(916); imagesc(kdVSslowGRID'); yticklabels({'1 x','1/5 x','1/10 x','1/20 x'}); xticklabels({'0.5','2.3','10','20','46'}); title(['Protein', 'g1 = ',num2str(g1), '-- kd vs speed']);
colorbar; xlabel('kd'); caxis([1.1 2.1]);
end