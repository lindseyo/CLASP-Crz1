function [flag] = Script20181129_updated_3state_constRONTF_fits()
flag = 1;
%% DON'T CHANGE STUFF -- this is the script to generate PARTS OF FIGURE 5
% load trajectories - set roffTHR at 0.5
load('20181204_3state_constRONTF_output10000.mat','allsGen')
X2 = allsGen;
...
%meanTransffn=mean(nmod_trans(indx_trans_1(1:500),:)); stdTransffn=std(nmod_trans(indx_trans_1(1:500),:));
...
% model end point
val = 60; % 5hrs 
%adhGyp = {allsGen_bR(indxFits(indx_trans_1(1:500)),1),allsGen_bR(indxFits(indx_trans_1(1:500)),4),allsGen_bR(indxFits(indx_trans_1(1:500)),7)};
%rplGyp = {allsGen_bR(indxFits(indx_trans_1(1:500)),1),allsGen_bR(indxFits(indx_trans_1(1:500)),15),allsGen_bR(indxFits(indx_trans_1(1:500)),16)};
