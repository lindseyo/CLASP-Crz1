function [flag] = Script20181129_updated_2state_konTHR_fits()
flag = 1;
%% DON'T CHANGE STUFF -- this is the script to generate PARTS OF FIGURE 5
% load trajectories - set roffTHR at 0.5
load('20181129_2state_konTHR_output10000.mat','allsGen')
X1 = allsGen;
load('20181129_2state_konTHR_2pt7_output10000.mat','allsGen')
X2 = allsGen;
