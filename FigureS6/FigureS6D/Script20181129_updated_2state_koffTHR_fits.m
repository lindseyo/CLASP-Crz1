function [flag] = Script20181129_updated_2state_koffTHR_fits()
flag = 1; 
%% DON'T CHANGE STUFF -- this is the script to generate PARTS OF FIGURE 5
% load trajectories - set roffTHR at 0.5
load('20181129_2state_koffTHR_output10000.mat','allsGen')
X1 = allsGen;
load('20181129_2state_koffTHR_2pt7_output10000.mat','allsGen')
X2 = allsGen;
...
Y1 = paramset(:,1:10000);
dir='C:\Users\susanychen\Google Drive\UCSF Graduate Research (El-Samad)\LANS OPTOGENETICS PROJECT\SYC Modeling\20181129_3addSuppModels\2state_koffTHR_0to2pt7\gpu_upload_folder\';
...
% figure(100); hist(err_transf_1,sqrt(numel(err_transf_1)));
...
%meanTransffn=mean(nmod_trans(indx_trans_1(1:5),:)); stdTransffn=std(nmod_trans(indx_trans_1(1:5),:));
...
title(['doseResp ErrTHRpt9, top',num2str(numel(indyyy)),'Param'])
